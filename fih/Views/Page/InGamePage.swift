            ...
            VStack(spacing: 4) {
                ...
                GeometryReader { geometry in
                    ZStack(alignment: .leading) {
                        ...
                        Image("zone_indicator_fill")
                            ...
                            .mask(
                                Rectangle()
                                    .frame(width: geometry.size.width * zoneProgress)
                                    .frame(maxWidth: .infinity, alignment: .leading)
                            )
                            .animation(.linear(duration: 1.0), value: zoneProgress)
                ...
                Text(controller.currentZone?.name ?? "")
                    ...
                    .animation(.easeInOut(duration: 0.5),
                               value: controller.currentZone?.name)
            }
        }
    }

        // Bar naik kontinu 0.0 → 1.0 berdasarkan km per zone
        // Zone 1: 0–30, Zone 2: 30–80, Zone 3: 80–150, Zone 4: 150+
    private var zoneProgress: CGFloat {
        let km = CGFloat(controller.distanceTravelledKm)
        let total: CGFloat = 350.0  // 30 + 50 + 70 + 200

        switch km {
        case ..<30:
            return (km / 30.0) * (70.0 / total)

        case 30..<80:
            return (70.0 / total) + ((km - 30.0) / 50.0) * (80.0 / total)

        case 80..<150:
            return (150.0 / total) + ((km - 80.0) / 70.0) * (90.0 / total)

        default:
            return min((240.0 / total) + ((km - 150.0) / 200.0) * (350.0 / total), 1.0)
        }
    }
...
//            VStack(spacing: 4) {
//                ZStack {
//                    // Layer 1 (bawah): Fill — berubah sesuai zone
//                    GeometryReader { geometry in
//                        Image("zone_indicator_fill")
//                            .resizable()
//                            .scaledToFit()
...
//                                    Rectangle()
//                                        .frame(
//                                            width: geometry.size.width * (CGFloat(currentZoneNumber) / 4.0)
//                                        )
//                                        // Animasi pelan saat width berubah
//                                        .animation(.easeInOut(duration: 0.8), value: currentZoneNumber)
//                                    Spacer(minLength: 0)
//                                }
//                            )
//                    }
//
//                    // Layer 2 (atas): Outline — selalu di atas, tidak tertimpa fill
//                    Image("zone_indicator_outline")
//                        .resizable()
//                        .scaledToFit()
//                }
...
//                    // Animasi nama zone juga ganti pelan
//                    .animation(.easeInOut(duration: 0.5), value: controller.currentZone?.name)
//            }
//        }
//    }
