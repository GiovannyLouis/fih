...
extension Equipment {
    static let allEquipment: [Equipment] = [
        ...
        Equipment(name: "Rocket Thrusters", imageName: "icon_rocket_thruster", description: "Increase speed by 20 knots", type: .rocketThrusters),
        ...
        Equipment(name: "Soul Eater", imageName: "icon_soul_eater", description: "For every fish caught, heals 3 HP", type: .soulEater)
    ]
}
