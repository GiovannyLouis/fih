...
extension Fish {
    static let allFish: [Fish] = [
        ...
        // ==================== ZONA 1 (Starter Zone) ====================
        Fish(zone: 1, name: "Tuna", info: "Ikan perenang cepat di lautan dangkal.", iconName: "fish_blue", isUnlocked: false),
        ...
        Fish(zone: 1, name: "Snapper", info: "Ikan karang dengan warna sisik kemerahan.", iconName: "fish_red", isUnlocked: false),
        
        // ==================== ZONA 2 (Reef Zone) ====================
        Fish(zone: 2, name: "Clownfish", info: "Bersembunyi di balik anemon beracun.", iconName: "fish_red", isUnlocked: false),
        ...
        Fish(zone: 2, name: "Grouper", info: "Kerapu besar yang bersembunyi di celah karang.", iconName: "fish_blue", isUnlocked: false),
        Fish(zone: 2, name: "Mahi Mahi", info: "Perenang lincah dengan warna hijau-kuning.", iconName: "fish_red", isUnlocked: false),
        Fish(zone: 2, name: "Barracuda", info: "Predator ganas dengan gigi setajam pisau.", iconName: "fish_blue", isUnlocked: false),
        
        // ==================== ZONA 3 (Deep Sea Zone) ====================
        Fish(zone: 3, name: "Anglerfish", info: "Memiliki lampu alami di atas kepalanya.", iconName: "fish_red", isUnlocked: false),
        ...
        Fish(zone: 3, name: "Blobfish", info: "Ikan berwajah murung dari laut dalam.", iconName: "fish_blue", isUnlocked: false),
        ...
        Fish(zone: 4, name: "Leviathan", info: "Monster laut dalam yang sangat legendaris.", iconName: "fish_red", isUnlocked: false),
        ...
        Fish(zone: 4, name: "Cosmic Whale", info: "Spesies misterius berukuran sebesar pulau.", iconName: "fish_blue", isUnlocked: false)
    ]
